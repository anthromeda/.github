...
# Main Projects
- **Diversy**: A modern and web-based social platform meant for a brighter and all-in-one usage including a marketplace for artists/professionals, the abiliy to custom your profile (free banner, host character sheets, custom CSS, etc.) and join diverse communities like does Reddit in which you find wikis, forums and real-time chat. ⇒ [https://github.com/anthromeda/Diversy-Frontend](https://github.com/anthromeda/Diversy-Frontend)
- **Shelter**: Meant to be a secure by design, privacy-first encrypted networking protocol, it first starts as an encrypted messaging sysrtem built on top of the UDP protocol. ⇒ [https://github.com/anthromeda/shelter](https://github.com/anthromeda/shelter)
